...
<head>
    ...
    <script type="text/javascript">
        ...
        function Status(val, row) {
            if (row.status == 0)
                return "<div style='color:green;'>在职</div>";
            else
                return "<div style='color:red;'>离职</div>";
        }
...
<table id="dg" title="护士管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th field="status" width="80" align="center" formatter="Status">护士状态</th>
...
<div id="tb">
    <div>
        <a href="javascript:openStoreAddDialog()"
           class="easyui-linkbutton" iconCls="icon-add" plain="true">添加人员</a>
        <a href="javascript:openStore()"
           class="easyui-linkbutton" iconCls="icon-kaiqi" plain="true">入职</a>
        <a href="javascript:closeStore()"
           class="easyui-linkbutton" iconCls="icon-guanbi" plain="true">离职</a>
        <!-- <a
